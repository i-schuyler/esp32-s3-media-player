...
- Expect OTA build/config diagnostics block to include env, board, flash mode, PSRAM mode, partition info, and running/target partition details for failure triage.
